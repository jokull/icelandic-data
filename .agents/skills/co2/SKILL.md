...
- [loftgaedi](../loftgaedi/SKILL.md) — real-time air-quality monitoring data
- [rikisreikningur](../rikisreikningur/SKILL.md) — state accounts (some CO₂ actions
  have funded line items visible there)
- [heimsmarkmid](../heimsmarkmid/SKILL.md) — SDG 13 (Climate action) reporting
