---
name: velsaeldarvisar
description: Hagstofa indicator catalogs on visar.hagstofa.is — velsældarvísar, félagsvísar, menningarvísar; 88 indicators to ~77 PX-Web tables.
---
...
via the existing [hagstofan](../hagstofan/SKILL.md) skill.
...
- Upstream: [hagstofan](../hagstofan/SKILL.md) — fetch actual values from a PX table code.
- Complementary dashboards on `stjornarradid.is/gogn/maelabord/` index:
  - [tekjusagan](../tekjusagan/SKILL.md) — income-distribution history (overlaps on
    `Lágtekjuhlutfall`, `Ójöfnuður tekna`).
  - [farsaeld_barna](../farsaeld-barna/SKILL.md) — child wellbeing.
