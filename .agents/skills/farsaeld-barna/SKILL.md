---
name: farsaeld-barna
description: Child wellbeing dashboard (farsaeldbarna.is) from Barna- og fjölskyldustofa — Power BI static data.
---
...
3. **Overlap with source datasets.** Many underlying series are already reachable more directly via [hagstofan](../hagstofan/SKILL.md), [landlaeknir](../landlaeknir/SKILL.md), or [reykjavik](../reykjavik/SKILL.md) (municipality-level welfare data). Prefer source when available.
...
| Source | Overlap |
|--------|---------|
| [hagstofan](../hagstofan/SKILL.md) | Education, demographics, living conditions |
| [landlaeknir](../landlaeknir/SKILL.md) | Child health, vaccination, dental health |
| [reykjavik](../reykjavik/SKILL.md) | Municipal welfare services for children |
| [domstolar](../domstolar/SKILL.md) | Child-related court rulings |
