---
name: landlaeknir
description: Directorate of Health (landlæknir) — ~30 Power BI dashboards: mortality, medication, healthcare, infectious disease; Talnabrunnur PDFs.
---
...
Same Playwright-intercept pattern as [ferdamalastofa](../ferdamalastofa/SKILL.md), [samgongustofa](../samgongustofa/SKILL.md), and [maelabord_landbunadarins](../maelabord-landbunadarins/SKILL.md):
...
| Source | Overlap |
|--------|---------|
| [hagstofan](../hagstofan/SKILL.md) | Cause of death (HEI02000), life expectancy, health status survey |
| [loftgaedi](../loftgaedi/SKILL.md) | Air-quality → respiratory health link |
