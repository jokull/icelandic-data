---
name: maelabord-landbunadarins
description: Icelandic agricultural subsidies (búvörusamningar), market and livestock data via Power BI. Per-farm recipients, busnr→landsnr crosswalk.
---
...
|--------|----------|----------|-------------|
| **iceaddr / Staðfangaskrá** (bundled SQLite, [iceaddr](../iceaddr/SKILL.md)) | ~138k landnúmer incl. historical farms | Point (lat/lon) | Default. ~100% hit rate for farm búsnúmer. |
| **HMS Landeignaskrá** (shapefile, [hms](../hms/SKILL.md#landeignaskrá-land-parcel-registry)) | ~89k formally surveyed parcels, only ~3.4k JÖRÐ | Polygon | When you need parcel boundaries, not just a point. Many farm búsnúmer miss here. |
...
|--------|-------|---------|
| Hagstofa LAN10201 | [hagstofan](../hagstofan/SKILL.md) | Meat production by species, 1983–present (annual) |
| Hagstofa LAN10103 | [hagstofan](../hagstofan/SKILL.md) | Harvest & products, 1977–present (annual) |
| Hagstofa LAN10102 | [hagstofan](../hagstofan/SKILL.md) | Livestock by region, 1980–present |
