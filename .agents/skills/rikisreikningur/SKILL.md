...
7. **Annual reports of state institutions and SOEs** live on sibling
   ...
   currently covered opportunistically by [skatturinn](../skatturinn/SKILL.md) for
   SOEs and [reykjavik](../reykjavik/SKILL.md) for the Reykjavík municipality.
...
- [opnirreikningar](../opnirreikningar/SKILL.md) — invoice-level government-spending data
- [tenders](../tenders/SKILL.md) — public-procurement awards
- [hagstofan](../hagstofan/SKILL.md) — GFS-standard fiscal aggregates (THJ tables)
