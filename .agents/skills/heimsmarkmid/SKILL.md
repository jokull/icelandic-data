---
name: heimsmarkmid
description: Iceland's UN Sustainable Development Goal statistics (open-sdg) — 137 indicators across all 17 goals.
---
...
7. **Overlap with [velsaeldarvisar](../velsaeldarvisar/SKILL.md).** About a dozen
...
- [velsaeldarvisar](../velsaeldarvisar/SKILL.md) — Hagstofa's wellbeing/social/cultural
  indicator portal. Separate content, partial thematic overlap.
- [hagstofan](../hagstofan/SKILL.md) — many SDG indicators are re-computations over
