---
name: vernd
description: Iceland international-protection (asylum) monthly stats from Ríkislögreglustjóri — applicants by year, nationality, gender, age.
---
...
[landlaeknir](../landlaeknir/SKILL.md). No auth, no token, no Playwright-drivable SPA:
...
- [landlaeknir](../landlaeknir/SKILL.md) — same `/view?r=` scrape pattern, 33 health dashboards
- [vinnumalastofnun](../vinnumalastofnun/SKILL.md) — related on labour-market side (work permits)
