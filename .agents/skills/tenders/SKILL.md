---
name: tenders
description: Icelandic public procurement — TED API and OCDS bulk data, 3,494+ tenders, award tracking, CPV search.
---
...
- [skatturinn](../skatturinn/SKILL.md) — contractor financials/ownership
- [reykjavik](../reykjavik/SKILL.md) — municipal CKAN data
- [financials](../financials/SKILL.md) — extract contractor annual reports
