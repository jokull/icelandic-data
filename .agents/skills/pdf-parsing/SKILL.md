---
name: pdf-parsing
description: Choose between docling, liteparse and pdfplumber for PDF extraction — tables, layout, fonts, screenshots, vector graphics.
---

# PDF Parsing — docling + liteparse + pdfplumber

**Requires:** Tier 0 (core) for pdfplumber; Tier 3 (pdf) for docling/liteparse: `uv sync --group pdf`.
